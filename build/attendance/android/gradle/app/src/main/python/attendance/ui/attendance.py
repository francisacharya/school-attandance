    ...
    def build(self):
        ...
        async def scan(widget):
            ...
            try:
                ...
                if not has_perm:
                    status.text = "Camera permission denied. Tap 'Grant Permission' or enable it in App Settings."
                    status.style.color = "#ef4444"
                ...
                if "permission" in err.lower() or "photo" in err.lower():
                    status.text = "Camera permission denied. Go to Settings > Apps > Attendance > Permissions > Camera"
                    grant_btn.style.display = "pack"
                else:
        ...
        async def request_permission_manual(widget):
            try:
                ...
                if granted:
                    ...
                    status.text = "Still denied. Go to: Settings > Apps > Attendance > Permissions > Camera"
                    status.style.color = "#f59e0b"
            except Exception as e:
